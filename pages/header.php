                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="card card-body border-0 p-0">
                            ...
                            <div class="text-end pb-3"><span class="text-danger">Forget password</span></div>
            ...
            <nav class="navbar navbar-expand-md py-0">
                <div class="container py-0">
                    ...
                    <ul class="navbar-nav mx-auto fw-bold text-secondary ">
                        ...
                        <li><a href="" class="nav-link py-4 "><?php echo $category['category_name']?></a></li>
                        <?php } ?>
                        <li><a href="action.php?page=about" class="nav-link py-4 ">About Us</a></li>
